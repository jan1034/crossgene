...
class TestWriteTsv:
    ...
    def test_single_hit(self, tmp_path):
        ...
        assert row[12] == "true"       # is_primary
        assert row[14] == "A→B"        # direction
    ...
    def test_sorting(self, tmp_path):
        ...
        assert rows[0][2] == "1000" and rows[0][11] == "100"
        assert rows[1][2] == "1000" and rows[1][11] == "80"
        # Second position, highest score first
        assert rows[2][2] == "2000" and rows[2][11] == "90"
        assert rows[3][2] == "2000" and rows[3][11] == "50"
